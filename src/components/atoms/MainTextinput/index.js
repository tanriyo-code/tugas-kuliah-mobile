...
const MainTextinput = (props) => {
    ...
    return (
        <View style={[styles.container, props.containerStyle]}>
            <TextInput value={props.value} multiline={props.multiline ?? false} numberOfLines={props.numberOfLines ?? 1} onKeyPress={props.onKeyPress} onChangeText={props.onChangeText} secureTextEntry={isPassword} style={[styles.TextInput, props.inputStyle]} placeholder={props.placeholder ?? 'Your placeholder ..'}></TextInput>
            {icon && 
